...
var file_shared_shared_proto_goTypes = []interface{}{
	(ContentType)(0), // 0: loop.hub.shared.ContentType
	(*Metadata)(nil), // 1: loop.hub.shared.Metadata
	nil,              // 2: loop.hub.shared.Metadata.TagsEntry
}
var file_shared_shared_proto_depIdxs = []int32{
	2, // 0: loop.hub.shared.Metadata.tags:type_name -> loop.hub.shared.Metadata.TagsEntry

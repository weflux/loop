...
const (
	Api_Publish_FullMethodName     = "/loop.hub.api.Api/Publish"
	Api_Survey_FullMethodName      = "/loop.hub.api.Api/Survey"
	Api_Subscribe_FullMethodName   = "/loop.hub.api.Api/Subscribe"
	Api_Unsubscribe_FullMethodName = "/loop.hub.api.Api/Unsubscribe"
	Api_Disconnect_FullMethodName  = "/loop.hub.api.Api/Disconnect"
)
